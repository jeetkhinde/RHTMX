...
fn test_route_from_path_index() {
    let route = Route::from_path("pages/page.rjx", "pages");
    assert_eq!(route.pattern, "/");
}

#[test]
fn test_route_from_path_nested_index() {
    let route = Route::from_path("pages/users/page.rjx", "pages");
...
fn test_route_priority() {
    let static_route = Route::from_path("pages/users/new.rjx", "pages");
    let dynamic_route = Route::from_path("pages/users/[id].rjx", "pages");
...
fn test_router_matching() {
    ...
    router.add_route(Route::from_path("pages/users/new.rjx", "pages"));
    router.add_route(Route::from_path("pages/users/[id].rjx", "pages"));
...
fn test_layout_route() {
    let route = Route::from_path("pages/users/_layout.rjx", "pages");
    assert_eq!(route.pattern, "/users");
...
fn test_catch_all_route() {
    let route = Route::from_path("pages/docs/[...slug].rjx", "pages");
...
fn test_optional_param_route() {
    let route = Route::from_path("pages/posts/[id?].rjx", "pages");
...
fn test_error_page_route() {
    let route = Route::from_path("pages/_error.rjx", "pages");
    assert_eq!(route.pattern, "/");
...
fn test_section_error_page() {
    let route = Route::from_path("pages/api/_error.rjx", "pages");
...
fn test_route_priority_ordering() {
    let static_route = Route::from_path("pages/users/new.rjx", "pages");
    let optional_route = Route::from_path("pages/users/[id?].rjx", "pages");
    let dynamic_route = Route::from_path("pages/users/[id].rjx", "pages");
    let catchall_route = Route::from_path("pages/users/[...rest].rjx", "pages");
...
fn test_router_with_all_route_types() {
    ...
    router.add_route(Route::from_path("pages/docs/[...slug].rjx", "pages"));
    router.add_route(Route::from_path("pages/docs/api.rjx", "pages"));
    router.add_route(Route::from_path("pages/posts/[id?].rjx", "pages"));
    router.add_route(Route::from_path("pages/posts/new.rjx", "pages"));
...
fn test_error_page_lookup() {
    ...
    router.add_route(Route::from_path("pages/api/_error.rjx", "pages"));
...
fn test_nested_layout_three_levels() {
    ...
    router.add_route(Route::from_path(
        "pages/dashboard/admin/_layout.rjx",
        "pages",
    ));
    router.add_route(Route::from_path(
        "pages/dashboard/admin/settings.rjx",
        "pages",
    ));
...
fn test_nested_error_page_three_levels() {
    ...
    router.add_route(Route::from_path("pages/_error.rjx", "pages"));
    router.add_route(Route::from_path("pages/api/_error.rjx", "pages"));
    router.add_route(Route::from_path("pages/api/v1/_error.rjx", "pages"));
    router.add_route(Route::from_path("pages/api/v1/users.rjx", "pages"));
...
fn test_layout_skips_missing_intermediate() {
    ...
    router.add_route(Route::from_path("pages/dashboard/_layout.rjx", "pages"));
    router.add_route(Route::from_path(
        "pages/dashboard/admin/users/settings.rjx",
        "pages",
    ));
...
fn test_layout_option_none() {
    ...
    let route = Route::from_path("pages/dashboard/print.rjx", "pages").with_no_layout();
...
fn test_layout_option_root() {
    ...
    let route =
        Route::from_path("pages/dashboard/admin/print.rjx", "pages").with_root_layout();
    router.add_route(route.clone());
...
fn test_layout_option_pattern() {
    ...
    let route = Route::from_path("pages/dashboard/admin/users/edit.rjx", "pages")
...
fn test_named_layout_detection() {
    let route = Route::from_path("pages/_layout.admin.rjx", "pages");
    assert_eq!(route.layout_name, Some("admin".to_string()));
    assert_eq!(route.pattern, "/");

    let route = Route::from_path("pages/dashboard/_layout.marketing.rjx", "pages");
    assert_eq!(route.layout_name, Some("marketing".to_string()));
    assert_eq!(route.pattern, "/dashboard");

    let route = Route::from_path("pages/_layout.rjx", "pages");
...
fn test_layout_option_named() {
    let mut router = Router::new();
    router.add_route(Route::from_path("pages/_layout.rjx", "pages"));
    router.add_route(Route::from_path("pages/_layout.admin.rjx", "pages"));
    router.add_route(Route::from_path("pages/dashboard/_layout.rjx", "pages"));

    let route = Route::from_path("pages/dashboard/settings.rjx", "pages")
...
fn test_get_layout_by_name() {
    let mut router = Router::new();
    router.add_route(Route::from_path("pages/_layout.admin.rjx", "pages"));
    router.add_route(Route::from_path("pages/_layout.marketing.rjx", "pages"));
...
fn test_functional_builder_chaining() {
    let route = Route::from_path("pages/dashboard/print.rjx", "pages")
        .with_root_layout();

    assert_eq!(route.layout_option, LayoutOption::Root);
    assert_eq!(route.pattern, "/dashboard/print");

    let route = Route::from_path("pages/login.rjx", "pages").with_no_layout();
    assert_eq!(route.layout_option, LayoutOption::None);

    let route = Route::from_path("pages/admin/users.rjx", "pages")
        .with_named_layout("admin");
    assert_eq!(
        route.layout_option,
...
fn test_complex_layout_scenario() {
    ...
    let route1 =
        Route::from_path("pages/dashboard/users.rjx", "pages").with_named_layout("admin");
    router.add_route(route1);

    // Route 2: No layout
    let route2 = Route::from_path("pages/dashboard/print.rjx", "pages").with_no_layout();
    router.add_route(route2);

    // Route 3: Root layout only
    let route3 =
        Route::from_path("pages/dashboard/export.rjx", "pages").with_root_layout();
    router.add_route(route3);

    // Route 4: Default (inherit)
    let route4 = Route::from_path("pages/dashboard/settings.rjx", "pages");
...
fn test_nolayout_marker_detection() {
    let route = Route::from_path("pages/dashboard/_nolayout.rjx", "pages");
    assert!(route.is_nolayout_marker);
    assert_eq!(route.pattern, "/dashboard");

    let route = Route::from_path("pages/_nolayout.rjx", "pages");
    assert!(route.is_nolayout_marker);
    assert_eq!(route.pattern, "/");
}
...
fn test_nolayout_marker_effect() {
    ...
    router.add_route(Route::from_path("pages/_layout.rjx", "pages"));
    router.add_route(Route::from_path("pages/dashboard/_layout.rjx", "pages"));
    router.add_route(Route::from_path("pages/dashboard/print/_nolayout.rjx", "pages"));
    router.add_route(Route::from_path(
        "pages/dashboard/print/invoice.rjx",
        "pages",
    ));
...
fn test_nolayout_marker_hierarchy() {
    ...
    router.add_route(Route::from_path("pages/_layout.rjx", "pages"));
    router.add_route(Route::from_path("pages/dashboard/_layout.rjx", "pages"));
    router.add_route(Route::from_path("pages/dashboard/_nolayout.rjx", "pages"));

    // Direct child - no layout
    router.add_route(Route::from_path("pages/dashboard/print.rjx", "pages"));
    let m = router.match_route("/dashboard/print").unwrap();
    assert!(router.get_layout_for_match(&m).is_none());

    // Nested child - also no layout
    router.add_route(Route::from_path(
        "pages/dashboard/reports/monthly.rjx",
        "pages",
    ));
    ...
    router.add_route(Route::from_path("pages/settings.rjx", "pages"));
...
fn test_is_under_nolayout_marker() {
    let mut router = Router::new();
    router.add_route(Route::from_path("pages/dashboard/_nolayout.rjx", "pages"));
    router.add_route(Route::from_path("pages/api/v1/_nolayout.rjx", "pages"));
...
fn test_route_with_metadata_batch() {
    ...
    let route =
        Route::from_path("pages/admin/dashboard.rjx", "pages").with_metadata(meta.clone());
...
fn test_metadata_chaining() {
    let route = Route::from_path("pages/products/[id].rjx", "pages")
...
fn test_metadata_override() {
    let route = Route::from_path("pages/settings.rjx", "pages")
...
fn test_constraint_parsing_from_filename() {
    ...
    // Alpha constraint
    let route = Route::from_path("pages/tags/[name:alpha].rjx", "pages");
    assert_eq!(
    ...
    // Slug constraint
    let route = Route::from_path("pages/posts/[slug:slug].rjx", "pages");
    assert_eq!(
...
fn test_constraint_uint_validation() {
    let route = Route::from_path("pages/products/[id:uint].rjx", "pages");
...
fn test_constraint_alphanum_validation() {
    let route = Route::from_path("pages/codes/[code:alphanum].rjx", "pages");
...
fn test_constraint_uuid_validation() {
    let route = Route::from_path("pages/items/[id:uuid].rjx", "pages");
...
fn test_constraint_optional_parameter() {
    let route = Route::from_path("pages/posts/[id:int?].rjx", "pages");
...
fn test_constraint_catch_all() {
    // App Router: pages/docs/[...slug]/page.rjx
    let route = Route::from_path("pages/docs/[...slug]/page.rjx", "pages");
...
fn test_multiple_constraints() {
    let route = Route::from_path("pages/posts/[year:int]/[slug:slug].rjx", "pages");
...
fn test_constraint_with_router_matching() {
    ...
    router.add_route(Route::from_path("pages/users/[id:int].rjx", "pages"));
    router.add_route(Route::from_path("pages/users/[name:alpha].rjx", "pages"));

    // Should match integer route
    let m = router.match_route("/users/123");
    assert!(m.is_some());
    assert_eq!(m.unwrap().route.template_path, "pages/users/[id:int].rjx");
...
fn test_route_with_aliases_batch() {
    let route = Route::from_path("pages/contact.rjx", "pages")
...
fn test_multiple_routes_with_aliases() {
    ...
    router.add_route(
        Route::from_path("pages/about.rjx", "pages")
            .with_aliases(["/about-us", "/company"])
    );

    router.add_route(
        Route::from_path("pages/contact.rjx", "pages")
    ...
    assert_eq!(m.route.template_path, "pages/about.rjx");

    let m = router.match_route("/contact-us").unwrap();
    assert_eq!(m.route.template_path, "pages/contact.rjx");
}
...
fn test_alias_legacy_url_support() {
    let route = Route::from_path("pages/products/page.rjx", "pages")
...
fn test_alias_priority_order() {
    ...
    router.add_route(
        Route::from_path("pages/products/new.rjx", "pages")
            .with_alias("/create-product")
    );

    // Add dynamic route
    router.add_route(Route::from_path("pages/products/[id].rjx", "pages"));

    // Static route should match first
    let m = router.match_route("/products/new").unwrap();
    assert_eq!(m.route.template_path, "pages/products/new.rjx");
    ...
    assert_eq!(m.route.template_path, "pages/products/[id].rjx");
}
...
fn test_functional_alias_composition() {
    ...
    let route = Route::from_path("pages/home.rjx", "pages")
...
fn test_generate_url_with_multiple_parameters() {
    let route = Route::from_path("pages/posts/[year]/[slug].rjx", "pages");
...
fn test_router_url_for() {
    ...
    router.add_route(
        Route::from_path("pages/users/[id].rjx", "pages")
            .with_name("user.profile")
    );
...
fn test_router_url_for_params() {
    ...
    router.add_route(
        Route::from_path("pages/posts/[year]/[slug].rjx", "pages")
            .with_name("post.show")
    );
...
fn test_router_get_route_by_name() {
    ...
    assert_eq!(route.pattern, "/about");
    assert_eq!(route.template_path, "pages/about.rjx");
}
...
fn test_multiple_named_routes() {
    ...
    router.add_route(
        Route::from_path("pages/page.rjx", "pages")
            .with_name("home")
    );
...
fn test_url_generation_preserves_order() {
    let route = Route::from_path("pages/events/[year]/[month]/[day].rjx", "pages");
...
fn test_named_route_type_safe_reference() {
    ...
    // Add route with name
    router.add_route(
        Route::from_path("pages/api/v1/users/[id].rjx", "pages")
    ...
    router.add_route(
        Route::from_path("pages/api/v2/users/[id].rjx", "pages")
...
fn test_redirect_legacy_url_support() {
    ...
    // New route
    router.add_route(Route::from_path("pages/products/page.rjx", "pages"));
...
fn test_redirect_chain_not_followed() {
    ...
    router.add_route(Route::from_path("pages/c.rjx", "pages"));
...
fn test_optional_catch_all_with_constraint() {
    let route = Route::from_path("pages/docs/[[...slug:alpha]].rjx", "pages");
...
fn test_optional_catch_all_vs_required_catch_all() {
    let optional = Route::from_path("pages/docs/[[...slug]].rjx", "pages");
    let required = Route::from_path("pages/blog/[...slug].rjx", "pages");
...
fn test_optional_catch_all_in_router() {
    ...
    assert_eq!(m.route.template_path, "pages/docs/[[...slug]].rjx");
...
fn test_optional_catch_all_with_static_prefix() {
    let route = Route::from_path("pages/api/v1/[[...path]].rjx", "pages");
...
fn test_optional_catch_all_route_priority_ordering() {
    ...
    router.add_route(Route::from_path("pages/docs/getting-started.rjx", "pages"));

    // Dynamic route
    router.add_route(Route::from_path("pages/docs/[section].rjx", "pages"));
    ...
    assert_eq!(m.route.template_path, "pages/docs/getting-started.rjx");

    // Dynamic should match next
    let m = router.match_route("/docs/api").unwrap();
    assert_eq!(m.route.template_path, "pages/docs/[section].rjx");
...
fn test_optional_catch_all_vs_optional_param() {
    ...
    let catch_all = Route::from_path("pages/docs/[[...slug]].rjx", "pages");
    let optional_param = Route::from_path("pages/users/[id?].rjx", "pages");
...
fn test_optional_catch_all_with_constraints_validation() {
    let route = Route::from_path("pages/files/[[...path:slug]].rjx", "pages");
...
fn test_route_group_basic() {
    let route = Route::from_path("pages/(marketing)/about.rjx", "pages");

    // Route group (marketing) should not appear in the pattern
    assert_eq!(route.pattern, "/about");
    assert_eq!(route.template_path, "pages/(marketing)/about.rjx");
}

#[test]
fn test_route_group_multiple() {
    let route = Route::from_path("pages/(marketing)/blog/posts.rjx", "pages");

    // Only (marketing) is skipped, blog is kept
    assert_eq!(route.pattern, "/blog/posts");
    assert_eq!(route.template_path, "pages/(marketing)/blog/posts.rjx");
}

#[test]
fn test_route_group_nested() {
    let route = Route::from_path("pages/(shop)/(products)/list.rjx", "pages");

    // Both (shop) and (products) should be skipped
    assert_eq!(route.pattern, "/list");
    assert_eq!(route.template_path, "pages/(shop)/(products)/list.rjx");
}

#[test]
fn test_route_group_with_dynamic_params() {
    let route = Route::from_path("pages/(shop)/products/[id].rjx", "pages");
...
fn test_route_group_organizational_structure() {
    ...
    router.add_route(Route::from_path("pages/(marketing)/blog/page.rjx", "pages"));

    // Shop routes
    router.add_route(Route::from_path("pages/(shop)/products/page.rjx", "pages"));
...
fn test_route_group_with_layout() {
    let marketing_layout = Route::from_path("pages/(marketing)/_layout.rjx", "pages");
    let shop_layout = Route::from_path("pages/(shop)/_layout.rjx", "pages");
...
fn test_route_group_same_path_different_groups() {
    ...
    router.add_route(Route::from_path("pages/(v1)/api/users.rjx", "pages"));
    router.add_route(Route::from_path("pages/(v2)/api/users.rjx", "pages"));
...
fn test_route_group_not_at_start() {
    let route = Route::from_path("pages/admin/(dashboard)/stats.rjx", "pages");
...
fn test_route_group_with_special_chars() {
    let route = Route::from_path("pages/(admin-panel)/users.rjx", "pages");

    // Group names can have hyphens
    assert_eq!(route.pattern, "/users");
    assert_eq!(route.template_path, "pages/(admin-panel)/users.rjx");
}

#[test]
fn test_route_group_priority_unchanged() {
    let grouped = Route::from_path("pages/(shop)/products.rjx", "pages");
    let non_grouped = Route::from_path("pages/products.rjx", "pages");
...
fn test_route_group_with_named_layout() {
    let route = Route::from_path("pages/(admin)/_layout.dashboard.rjx", "pages");
...
fn test_route_group_real_world_organization() {
    ...
    // Auth group
    router.add_route(Route::from_path("pages/(auth)/login.rjx", "pages"));
    router.add_route(Route::from_path("pages/(auth)/signup.rjx", "pages"));
    router.add_route(Route::from_path("pages/(auth)/reset-password.rjx", "pages"));

    // Dashboard group
    router.add_route(Route::from_path("pages/(dashboard)/home.rjx", "pages"));
    router.add_route(Route::from_path("pages/(dashboard)/settings.rjx", "pages"));

    // Public group
    router.add_route(Route::from_path("pages/(public)/about.rjx", "pages"));
    router.add_route(Route::from_path("pages/(public)/contact.rjx", "pages"));
    ...
    assert_eq!(m.route.template_path, "pages/(auth)/login.rjx");

    let m = router.match_route("/home").unwrap();
    assert_eq!(m.route.template_path, "pages/(dashboard)/home.rjx");
}
...
fn test_route_group_does_not_affect_params() {
    let route = Route::from_path("pages/(api)/users/[id]/posts/[postId].rjx", "pages");
...
fn test_route_group_multiple_levels() {
    let route = Route::from_path("pages/(app)/(dashboard)/(main)/home.rjx", "pages");

    // All three groups should be skipped
    assert_eq!(route.pattern, "/home");
    assert_eq!(route.template_path, "pages/(app)/(dashboard)/(main)/home.rjx");
}
...
fn test_loading_ui_detection() {
    ...
    assert_eq!(loading.template_path, "pages/dashboard/loading.rjx");
}
...
fn test_loading_ui_hierarchical_resolution() {
    ...
    // Stats loading
    router.add_route(Route::from_path("pages/dashboard/stats/loading.rjx", "pages"));
...
fn test_template_detection() {
    ...
    assert_eq!(template.template_path, "pages/dashboard/_template.rjx");
}
...
fn test_template_hierarchical_resolution() {
    ...
    // Root template
    router.add_route(Route::from_path("pages/_template.rjx", "pages"));

    // Dashboard template
    router.add_route(Route::from_path("pages/dashboard/_template.rjx", "pages"));

    // Stats template
    router.add_route(Route::from_path("pages/dashboard/stats/_template.rjx", "pages"));
...
fn test_not_found_detection() {
    ...
    assert_eq!(not_found.template_path, "pages/dashboard/not-found.rjx");
}
...
fn test_not_found_hierarchical_resolution() {
    ...
    // Stats not-found
    router.add_route(Route::from_path("pages/dashboard/stats/not-found.rjx", "pages"));
...
fn test_special_files_with_route_groups() {
    ...
    router.add_route(Route::from_path("pages/(app)/loading.rjx", "pages"));
    router.add_route(Route::from_path("pages/(app)/_template.rjx", "pages"));
    router.add_route(Route::from_path("pages/(app)/not-found.rjx", "pages"));
    ...
    assert_eq!(loading.template_path, "pages/(app)/loading.rjx");
}
...
fn test_parallel_route_detection() {
    let route = Route::from_path("pages/dashboard/@analytics/page.rjx", "pages");

    assert!(route.is_parallel_route);
    assert_eq!(route.parallel_slot, Some("analytics".to_string()));
    // @analytics is skipped from pattern
    assert_eq!(route.pattern, "/dashboard");
    assert_eq!(route.template_path, "pages/dashboard/@analytics/page.rjx");
}
...
fn test_parallel_route_multiple_slots() {
    ...
    router.add_route(Route::from_path("pages/dashboard/@settings/page.rjx", "pages"));
...
fn test_parallel_route_specific_slot() {
    ...
    assert_eq!(analytics.template_path, "pages/dashboard/@analytics/page.rjx");

    let team = router.get_parallel_route("/dashboard", "team").unwrap();
    assert_eq!(team.parallel_slot, Some("team".to_string()));
    assert_eq!(team.template_path, "pages/dashboard/@team/page.rjx");
}
...
fn test_parallel_route_with_route_groups() {
    let route = Route::from_path("pages/(shop)/products/@sidebar/list.rjx", "pages");
    ...
    assert_eq!(route.template_path, "pages/(shop)/products/@sidebar/list.rjx");
}

#[test]
fn test_parallel_route_nested() {
    let route = Route::from_path("pages/app/@modal/profile/@details/page.rjx", "pages");
...
fn test_parallel_route_collection_accessor() {
    ...
    router.add_route(Route::from_path("pages/dash/@a/page.rjx", "pages"));
    router.add_route(Route::from_path("pages/dash/@b/page.rjx", "pages"));
    router.add_route(Route::from_path("pages/other/@c/page.rjx", "pages"));
...
fn test_intercepting_route_with_route_groups() {
    let route = Route::from_path("pages/(app)/feed/(.)/photo/[id].rjx", "pages");
...
fn test_intercepting_route_collection_accessor() {
    ...
    router.add_route(Route::from_path("pages/feed/(.)/photo/[id].rjx", "pages"));
    router.add_route(Route::from_path("pages/gallery/(..)/image/[id].rjx", "pages"));
...
fn test_intercepting_route_with_catch_all() {
    let route = Route::from_path("pages/app/(...)/docs/[...slug].rjx", "pages");
...
fn test_intercepting_route_real_world_modal() {
    ...
    // Feed page
    router.add_route(Route::from_path("pages/feed/page.rjx", "pages"));
...
fn test_parallel_route_in_intercepting_route() {
    let route = Route::from_path("pages/feed/(.)/modal/@content/page.rjx", "pages");
...
fn test_phase_5_with_all_previous_features() {
    ...
    router.add_route(Route::from_path("pages/(app)/dashboard/page.rjx", "pages"));

    // Parallel routes (Phase 5.1)
    router.add_route(Route::from_path("pages/dash/@analytics/page.rjx", "pages"));
    router.add_route(Route::from_path("pages/dash/@team/page.rjx", "pages"));
